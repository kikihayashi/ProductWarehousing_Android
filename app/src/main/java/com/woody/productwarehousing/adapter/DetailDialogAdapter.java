...
public class DetailDialogAdapter extends RecyclerView.Adapter<DetailDialogAdapter.MyViewHolder>{
    ...
    public DetailDialogAdapter(List<SourceBean> list, RecyclerViewItemClickListener listener) {
        toolModelList = list;
    ...
    @Override
    //產生介面
    public DetailDialogAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType)
    {
        ...
        DetailDialogAdapter.MyViewHolder tool_item_holder = new DetailDialogAdapter.MyViewHolder(v);
    ...
    {
        //進行判断，如果沒資料，設置viewType為空布局，背景使用空白，反之使用正常布局
    ...
    @Override
    //設置ViewHolder裡的View
    public void onBindViewHolder(@NonNull DetailDialogAdapter.MyViewHolder holder, final int position) {
